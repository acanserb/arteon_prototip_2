...
export default function Implant() {
  ...
  useFrame(() => {
    ...
    const floatT = phaseT(progress, PHASES.implant[0], PHASES.implant[0] + 0.08);
    const settleT = phaseT(progress, PHASES.implant[0] + 0.08, PHASES.implant[1]);
    ...
    SCREW_OFFSETS.forEach((offset, i) => {
      ...
      const t = phaseT(progress, hardwareBase + stagger, hardwareBase + stagger + 0.05);
    ...
    const rodStart = hardwareBase + 0.06;
